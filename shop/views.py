...
# 	max_price_products = products.order_by('-price')[:5]
# 	min_price_products = products.order_by('price')[:5]
# 	latest_products = products.order_by('-created')[:5]
...
def product_list(request, category_slug=None, filter_slug=None):
    ...
    if category_slug:
        ...
        products =  Product.objects.filter(available=True, translations__language_code=language, category=category)
